...
public class Example2_answer_1209 {

	public static void main(String[] args) {
		
		URLAnalyzer_answer urla = new URLAnalyzer_answer("https://www.naver.com/index.html?id=admin&pw=1234&type=manager");
		urla.initialization();
		...
		URLParameter param = urla.getParam(1);
		if(param == null)
		{
